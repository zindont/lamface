<?php
    ...
    $total = $wpdb->get_var("SELECT COUNT(*) FROM $table_name_post WHERE feed_id IN ($in) $boloc");
    $datas = $wpdb->get_results("SELECT * FROM $table_name_post WHERE feed_id IN ($in) $boloc LIMIT 0,$number_item",OBJECT);
...
<?php
    if($total > $number_item){
        ...
        <div class='bulkff_nav'>
            ...
            onchange="bulkff_nav_change(this);" 
            data-cat="<?php echo $id;?>" 
